...
test_that("pgx.createPGX runs without errors", {
  ...
  # Create expected outputs
    ...
    genes <- data.frame(gene_name = c("A1BG", "ACOT9", "ALG12", "ANXA7", "ARF5", "ARPC4"),
                        gene_title = c("alpha-1-B glycoprotein", "acyl-CoA thioesterase 9",
  ...
  expect_equal(apply(pgx$genes, 2, class), 
              apply(genes, 2, class))
